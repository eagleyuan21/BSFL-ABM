...
to-report fitness-function
  ...
  report ( ( ( count-close - f-optimal ) / f-optimal ) ^ 2 + ( ( count-wall - w-optimal ) / w-optimal ) ^ 2 +
    ( ( ( ticks - count-close - count-wall ) - m-optimal ) / m-optimal ) ^ 2 ) / 3
end
...
"" ""
PENS
"" 1.0 0 -16777216 true "" "ask larva [plot eating-or-not-value]"
