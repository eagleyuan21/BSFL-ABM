...
to manage-vectors
  if vectors? [
    ...
    if ticks > 50 [
      ask vectors [
        let larvi-near larvi in-radius 5
        if any? larvi-near [
...
221
number of overlaps
count patches with [ count larvi-here > 1 ]
17
1
11
...
count patches with [ count turtles-here > 2 ]
17
1
11
...
1125
281
#larvi, for hunger spacing
mean [count larvi-on neighbors] of larvi
17
1
11
...
1177
340
max #larvi, for hunger spacing
max [count larvi-on neighbors] of larvi
17
1
11
