...
to adjust-for-wall ;; delete/change later
  ...
  [
    let i 1
    while [not can-move? vision or ([ food-source? ] of patch-ahead vision = true)] [ ;infinite loop here
...
to adjust-for-larvi
  ...
  if any? pushing-set [
    ...
    set heading 90 fd sum [dx + (xcor - xcor-prev)] of pushing-set
    set heading 0 fd sum [dy + (ycor - ycor-prev)] of pushing-set
