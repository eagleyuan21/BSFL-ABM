      ...
      if any? larvi-near [
        ifelse average? [
          if ticks > vector-start [
            ...
            if x-component-sum = 0 and y-component-sum = 0 [
...
to-report calculate-vorticity [ radius ]
  ...
  ifelse (any? vectors-at 0 r) and (any? vectors-at 0 (- r)) and (any? vectors-at r 0) and (any? vectors-at (- r) 0) [
    ...
    let partial-Vx ([y-component-sum / larvi-total] of one-of vectors-at 0 r - [y-component-sum / larvi-total] of one-of vectors-at 0 (- r)) / (2 * r)
    report partial-Vy - partial-Vx ]
  [ report 0 ]
end
